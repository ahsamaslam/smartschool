...
-- Rolling Student Health Scores (updated after each daily calculation)
CREATE TABLE student_health_scores (
    ...
    momentum DECIMAL(6,2) DEFAULT 0,     -- % change week-over-week
    risk_level VARCHAR(20) DEFAULT 'stable', -- critical/at_risk/stable/excelling
...
CREATE TABLE class_vitality_index (
    ...
    struggling_count INT DEFAULT 0,       -- SHS < 50
    excelling_count INT DEFAULT 0,        -- SHS >= 80
    total_students INT DEFAULT 0,
    engagement_variance DECIMAL(5,2) DEFAULT 0,
    learning_velocity DECIMAL(6,2) DEFAULT 0,  -- improvement rate
...
CREATE TABLE performance_alerts (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    alert_type VARCHAR(50) NOT NULL,   -- immediate_intervention/schedule_meeting/monitor_closely
...
CREATE TABLE ai_performance_insights (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    entity_type VARCHAR(20) NOT NULL,        -- student/class/school
    entity_id UUID NOT NULL,
    analysis_date DATE NOT NULL,
    exam_readiness_score DECIMAL(5,2),
    dropout_risk VARCHAR(20),                -- low/medium/high

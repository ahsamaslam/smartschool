          ...
          <table className="min-w-full divide-y divide-gray-100">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden md:table-cell">
                  Branch
                </th>
                <th className="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">
                  Session
                </th>
              ...
              {filtered.map((s) => (
                <tr key={s.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-3 py-3 text-xs text-gray-500 hidden sm:table-cell">
                    <span className="truncate max-w-[180px] block">{s.email}</span>
                  </td>
                  <td className="px-3 py-3">

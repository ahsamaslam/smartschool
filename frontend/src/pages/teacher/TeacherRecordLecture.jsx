 ...
 */
export default function TeacherRecordLecture() {
  ...
  if (!topicKey) {
    return <Navigate to="/teacher/my-lectures" replace />;
  }
  ...
  if (!topicRow?.id) {
    return (
      <div className="p-6 max-w-xl mx-auto text-center">
        ...
        <button type="button" onClick={() => navigate("/teacher/curriculum")} className="text-indigo-600 font-semibold">
          ← Back to Library
        </button>
      </div>
    );

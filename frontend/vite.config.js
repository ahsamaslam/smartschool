...
// Keep Vite's cache OUT of OneDrive — EPERM often happens when sync locks node_modules/.vite
const viteCacheDir = path.join(os.tmpdir(), "smartschool-frontend-vite-cache");
